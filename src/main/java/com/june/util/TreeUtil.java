...
/**
 * 把一个list集合,里面的bean含有 parentId 转为树形式 <br>
 * 如果大数据量就别考虑使用此类了，递归方法实现的<br>
 * 
 * @author 王俊伟 wjw.happy.love@163.com
 * @date 2016年9月19日 下午6:48:37
 */
public class TreeUtil {

	final Logger logger = Logger.getLogger(TreeUtil.class);
	 ...
	 * 递归列表
	 * 
	 * @author june Email: wjw.happy.love@163.com
